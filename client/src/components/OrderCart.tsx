    ...
    return (
        <div
...

            {
                ...
                <div className="pt-2">
                    <button className="w-full rounded-lg border border-orange-500 py-2 text-xs font-semibold text-orange-500 hover:border-orange-700 transition disabled:opacity-50 cursor-pointer" onClick={()=> updateStatus('ready_for_rider')}>Retry Ready for Rider</button>
                </div>
            }
        </div>
    )
