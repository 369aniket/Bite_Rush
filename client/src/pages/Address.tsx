...
const LocateMeButton = ({
    ...
    return (
        <button
            onClick={locateUser}
            className="absolute right-3 top-3 z-1000 flex items-center gap-2 rounded-l px-3 py-2 text-sm shadow bg-gray-800 hover:bg-gray-900 transition-all"
        >
    ...
    return (
        <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
            ...
            <button
                disabled={adding}
                onClick={addAddress}
                className="flex items-center justify-center gap-2 rounded-lg bg-orange-500 px-4 py-3 text-white hover:bg-[#d32f3a] disabled:opacity-50"
            >
